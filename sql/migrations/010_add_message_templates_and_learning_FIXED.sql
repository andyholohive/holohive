-- ============================================================================
-- Message Templates & Learning System (FIXED)
-- ============================================================================
...
-- ============================================================================
DROP TABLE IF EXISTS ai_message_feedback CASCADE;
DROP TABLE IF EXISTS client_message_examples CASCADE;
...
-- ============================================================================
-- 3. Message Examples Table (Learning Database)
-- ============================================================================
-- Stores actual messages sent to clients (for learning and context)
CREATE TABLE client_message_examples (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
CREATE INDEX idx_client_message_examples_user ON client_message_examples(user_id);
CREATE INDEX idx_client_message_examples_client ON client_message_examples(client_id);
CREATE INDEX idx_client_message_examples_campaign ON client_message_examples(campaign_id);
CREATE INDEX idx_client_message_examples_type ON client_message_examples(message_type);
CREATE INDEX idx_client_message_examples_rating ON client_message_examples(user_rating DESC);

-- Vector similarity search index
CREATE INDEX idx_client_message_examples_embedding
...
CREATE INDEX idx_ai_message_feedback_message ON ai_message_feedback(message_example_id);
CREATE INDEX idx_ai_message_feedback_type ON ai_message_feedback(feedback_type);
...
CREATE INDEX idx_template_usage_analytics_template ON template_usage_analytics(template_id);
CREATE INDEX idx_template_usage_analytics_period ON template_usage_analytics(period_start, period_end);
...
DROP FUNCTION IF EXISTS calculate_edit_similarity(TEXT, TEXT);
-- Note: Don't drop update_updated_at_column() as it's used by other tables
...
DROP FUNCTION IF EXISTS search_similar_messages(TEXT, TEXT, FLOAT, INT);
