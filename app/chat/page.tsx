            ...
            <ScrollArea className="flex-1 min-h-0 p-4">
              <div className="max-w-3xl mx-auto space-y-4">
                ...
                {currentSession?.messages.map((msg) => {
                  ...
                  // Check if this is a KOL search result
                    ...
                    >
                      ...
                      >
                        <div className="flex items-start space-x-3">
                          {msg.role === 'assistant' && (
                            <div className="rounded-full p-1.5 w-8 h-8 flex-shrink-0 mt-0.5 shadow-sm" style={{ backgroundColor: '#f6feff' }}>
                              <Image src="/images/logo.png" alt="Logo" width={20} height={20} className="rounded-full" />
                            </div>
                          )}
